 ...
 */
public class QQBrowserTabBehavior extends HeaderScrollingViewBehavior {
    private static final String TAG = "UcNewsTabBehavior";

    public QQBrowserTabBehavior() {
    }

    public QQBrowserTabBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private int getFinalHeight() {
        return DemoApplication.getAppContext().getResources().getDimensionPixelOffset(R.dimen.header_title_height);
    }
