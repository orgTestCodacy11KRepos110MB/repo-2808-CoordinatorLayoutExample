...
public class NestedWebView3 extends WebView implements NestedScrollingChild3 {
    ...
    public NestedWebView3(Context context) {
        this(context, null);
    }

    public NestedWebView3(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    public NestedWebView3(Context context, AttributeSet attrs, int defStyleAttr) {
