...
import com.xj.behavior.base.HeaderBehavior;
 ...
 */
public class NewHeaderBehavior extends HeaderBehavior {
    ...
    public NewHeaderBehavior() {
        init();
    }

    public NewHeaderBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
